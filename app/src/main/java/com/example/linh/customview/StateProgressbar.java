...
//    private Drawable icRewardBox;
    ...
    /** start from 1 */
    private int animationLevelOpenedAtLevel;
...
//        bgRoundabout.draw(canvas);
    ...
    protected void constructor(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        progressRadius = (int) ((float)progressWidth/2);
...
//        icRewardBox = getResources().getDrawable(R.drawable.ic_reward_box);
        ...
        bgSparkle = getResources().getDrawable(R.drawable.bg_sparkle);
                    ...
                    postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if(alpha > 255) {
                                ...
                                animationLevelOpenedAtLevel = finalLevel; // TODO: 22/02/2017 this line should be removed
//                        resetProgress();// TODO: 22/02/2017 this line should be removed
                                if (callback != null) {
                ...
                if (animationLevelOpenedAtLevel == level){
...
//                                restoreProgressBackup();
    ...
    private void onDrawProgressIndicator(Canvas canvas){
        ...
        String progressS = minimizeProgress(progress);
...
//    }
    ...
    private String minimizeProgress(int progress){
        return String.valueOf(progress);
    }

    private void animateLevelOpened(int level){
        animationLevelOpenedAtLevel = level;
        invalidate();
    }
    ...
    public interface LevelReachCallback{
         ...
         */
        public void reachLevel(int level, int remain);
    }
}
